  ...
  <div class="big-data-panel">
    ...
    <el-row class="ui-row">
      <el-col :span="5">
        ...
        <el-col :span="24">
          <weather-option :id="0" :visible.sync="DialogVisile[0]" @updateOption="updateWeatherOption" @toggleDialog="toggleDialog"></weather-option>
      ...
      <el-col :span="5">
        ...
        <el-col :span="24" class="col">
          <chart-operation-option :id="6" :visible.sync="DialogVisile[6]" :options="OptionData.OperationChartData" @toggleDialog="toggleDialog"></chart-operation-option>
      ...
      OptionData: {
        ...
        DeviceChartOptions: {
          ...
          data: {
            ...
            active: [100, 500, 600, 750, 800],
            increase: [20, 40, 50, 60, 100],
            // Pie chart data
            pieActiveData: [
              { value: 335, name: 'A' },
              { value: 34, name: 'B' },
        ...
        UserChartOptions: {
          ...
          data: {
            ...
            active: [100, 120, 202, 320, 400, 400],
            increase: [5, 10, 11, 12, 30, 20],
            // Pie chart data
            pieActiveData: [
              { value: 135, name: 'A' },
              { value: 234, name: 'B' },
        ...
        MaintainChartOptions: {
          integrals: ['1月', '2月', '3月', '4月', '5月'],
          data: {
            update: [100, 200, 300, 400, 500],
            maintain: [100, 300, 400, 600, 800],
            calibration: [20, 50, 40, 80, 43, 67]
          }
        },
        // 设备类型图表数据
        DeviceTypeChartData: {
        ...
        ProjectSampleData: {
          data: [
            ...
            },
            {
              ...
              name: '绿地大厦',
              icon: '工程示意图地址',
              imgs: [{ id: 0, url: '案列图片1' }, { id: 1, url: '案列图片2' }]
            },
            {
              id: 7,
              name: '万达武汉',

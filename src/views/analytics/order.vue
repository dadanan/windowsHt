  ...
  <div class="dashboard-container">
    ...
    <el-card>
      ...
      <el-table :data="tableData" style="width: 100%" class="mb20" border>
        ...
        <el-table-column v-for="data in columnData" :key="data.prop" :prop="data.prop" :label="data.label" :width="data.width">
        </el-table-column>
      </el-table>
      <div class="excel-container">
        <el-pagination :current-page="currentPage" :page-sizes="[100, 200, 300, 400]" :page-size="pagesize" layout="total, sizes, prev, pager, next, jumper" :total="total">
        </el-pagination>

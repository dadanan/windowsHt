<template>
  <el-dialog top='4vh' :close-on-click-modal=false  title="设备备案创建" :visible="visible" @update:visible="$emit('update:visible', $event)">
    <el-form label-width="100px" label-position="left">
      ...
      <el-form-item label="设备默认名称">
        <el-input v-model="placeholder"></el-input>
      </el-form-item>
      <el-form-item label="设备默认型号">
        <el-input v-model="placeholder"></el-input>
      </el-form-item>

<template>
  <el-dialog top='4vh'
    ...
    <el-form v-else-if='step === 2'
      ...
      <el-form-item label="DeviceID余额">
        <div class='inline-input'>
          <el-input v-model="form.devicePoolCount"
                    disabled></el-input>
        </div>
      </el-form-item>
    </el-form>
    ...
    <el-form v-else-if='step===4'
      ...
      <template v-for='item in pageOfForamt'>
        <el-card class='box-card'
          ...
          <el-table :data="item.modelFormatItems"
                    style="width: 100%"
                    class="mb20"
                    border>
    ...
    <div slot="footer"
      ...
      <el-button type="primary"
                 v-else
                 @click="updateDeviceModel">确定</el-button>
    </div>
    <el-dialog top='4vh'
               :close-on-click-modal=false
               title="自定义"
      ...
      <el-form label-width="100px"
        ...
        <el-form-item v-if='modifyData.abilityType===2 || modifyData.abilityType === 3'
                      v-for="(option, i) in modifyData.deviceModelAbilityOptions"
                      :key="i"
                      :label="'选项 ' + i">

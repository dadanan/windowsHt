  ...
  <el-dialog title="编辑功能" :visible="visible" @update:visible="$emit('update:visible', $event)">
    <el-form label-width="100px" class="mb-22">
      ...
      <el-form-item label="硬件功能 ID">
        <el-input v-model="form.functionId" disabled></el-input>
      </el-form-item>
      <el-form-item label="备注">
        <el-input v-model="form.description" type="textarea" :autosize="{ minRows: 4 }" disabled></el-input>
      </el-form-item>
      <el-form-item label="读写权限">
        <el-checkbox-group v-model="form.permissionList" @change="handlePermissionListChange" disabled>
      ...
      <template v-if="form.config">
        <el-form-item label="配置方式">
          <el-radio-group v-model="form.config.type" @change="handleConfigTypeChange" disabled>

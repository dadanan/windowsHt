<template>
  <div>
          ...
          <div v-if="createStep == 0">
            ...
            >
              ...
              <el-form-item label="工程建设地址">
                <el-input
                  v-model="form.buildAddress"
                  style="width:590px"
                  placeholder="请选择上面工程地址"
                  disabled
                ></el-input>
              </el-form-item>
              <el-form-item>
          ...
          <div v-if="createStep == 1">
            ...
            >
              ...
              <el-form-item label="添加其他设备">
                <el-button
                  type="primary "
                  @click="otherDeve = true"
                >添加</el-button>
              </el-form-item>
              <el-form-item>
                <el-table
                  :data="form.extraDeviceList"
                  style="width: 100%"
                  class="mb20"
                  border
    ...
    >
      ...
      >
        ...
        <el-form-item label="说明书">
          <file-uploader
            @get-url='setURL(arguments,addDeve,"direction")'
            :fileName='addDeve.direction'
          ></file-uploader>
        </el-form-item>
      </el-form>
      <div
    ...
    <el-dialog
      ...
      :close-on-click-modal=false
      title="添加耗材类"
      :visible.sync="consumablesDeve"
    >
      <el-form
        label-width="80px"
        label-position="left"
        :model="consumablesList1"
      >

<template>
  <div>
    <el-dialog top='4vh' :close-on-click-modal=false title="修改工程" :visible="visible" width="800px" @update:visible="$emit('update:visible', $event)" >
        ...
        <div>
          ...
          <div v-if="createStep == 0">
            <el-form label-position="left" label-width="150px" >
              ...
              <el-form-item label="任务描述">
                <el-input type="textarea" :rows="2" placeholder="任务描述..." v-model="form.description" ></el-input>
              </el-form-item>
          ...
          <div v-if="createStep == 1">
            <el-form label-position="left" label-width="150px" >
              ...
              <el-form-item>
                <el-tag v-if="selectedDeviceList.length >0" v-for="item in selectedDeviceList" :value="item.id" :key="item.name" :type="item.type" @close="handleClose(item)" style="margin:0px 10px" >
                  {{item.name}}
                </el-tag>
              </el-form-item>
    ...
    <el-dialog top='4vh' :close-on-click-modal=false :visible.sync="addEle" >
      <el-table :data="projects" style="width: 100%" class="mb20" border ref="multipleTable" @selection-change="handleSelectionChange" >

  ...
  <el-dialog top='4vh' :close-on-click-modal=false title="创建实施阶段" :visible="visible" :before-close="handleCancel" @update:visible="$emit('update:visible', $event)">
      <el-form label-width="130px" class="mb-22" :model="form" ref="form">
        <el-form-item label="工程资料分类名称" prop="name">
          <el-input v-model="form.name" placeholder="工程资料分类名称" disabled></el-input>
        </el-form-item>
        ...
        <el-form-item label="工程资料分类描述">
          <el-input type="textarea" :rows='3' placeholder="工程资料分类描述..." v-model='form.createUserOpenId' disabled></el-input>
        </el-form-item>
      </el-form>

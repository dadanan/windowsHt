      ...
      <div v-if="step == 1">
        <el-form label-position="left"
          ...
          <el-form-item label="首页缩图">
            <image-uploader :url='addForm.previewImg'
                            @get-url='setURL(arguments,addForm,"previewImg")'></image-uploader>
          </el-form-item>
        ...
        <el-card v-for='(item,index) in pages'
          ...
          <el-form label-position="left"
            ...
            <el-form-item label="页面图片"
                          prop='roleName'>
              <image-uploader :url='item.showImg'
                              @get-url='setURL(arguments,item,"showImg")'></image-uploader>
            </el-form-item>
